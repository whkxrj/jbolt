...
public class JBoltBaseController extends JBoltCommonController {
	...
	public void renderDialogError(String msg) {
		JBoltControllerKit.renderDialogError(this,msg);
	}
	/**
	 * dialog里请求页面返回错误信息
	 * @param ret
	...
	public void renderFormError(String msg) {
		JBoltControllerKit.renderFormError(this,msg);
	}
	@NotAction
	...
	public void renderErrorPjax(String msg) {
		JBoltControllerKit.renderErrorPjax(this, msg);
	}
	@NotAction
	...
	protected void renderErrorPortal(String msg) {
		JBoltControllerKit.renderErrorPortal(this,msg);
	}
	...
	public boolean isAdminLogin(){
		return isOk(getSessionAdminUserId());
	}
	/**
	 * 得到后台管理用户是否是超级管理员
	 * @return
