 ...
 */
public class GoodsTypeService extends JBoltBaseService<GoodsType> {
	...
	public Ret toggleEnable(Integer userId, Integer id) {
		...
		if(ret.isOk()){
			...
			return successWithData(goodsType.getEnable());
		}
		return ret;
	}
	/**
	...
	public Page<GoodsType> paginateAdminList(String keywords, Integer pageNumber, Integer pageSize) {
		if(notOk(keywords)) {
			return paginate("sort_rank","asc",pageNumber, pageSize);
		}
