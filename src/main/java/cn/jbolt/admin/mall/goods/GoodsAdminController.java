...
public class GoodsAdminController extends JBoltBaseController {
	@Inject
	 ...
	 */
	public void datas() {
		renderJsonData(service.paginateAdminData(getPageNumber(),getPageSize(),getKeywords(),getBoolean("onSale"),getBoolean("isHot"),getBoolean("isRecommend"),getBoolean("isDelete",false),getInt("bcategoryId"),getInt("fcategoryId")));
	}
	/**
	 * 进入添加新商品
	 */
	...
	public void uploadImage(){
		...
		String uploadPath=JBoltUploadFolder.MALL_GOODS_IMAGE+"/"+todayFolder+"/"+goodsId;
