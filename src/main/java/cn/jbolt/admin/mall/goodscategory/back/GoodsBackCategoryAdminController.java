...
public class GoodsBackCategoryAdminController extends JBoltBaseController {
	@Inject
	...
	/*	@Before(Tx.class)
		 ...
		 */
		public void mgrTree(){
			renderJsonData(service.getMgrTree(getInt(0),get("openType")));
		}
		...
		public void goodsFilterTree() {
			renderJsonData(service.getEnableTree(getInt(0,0),get("openType")));
		}
		/**
		 * 添加商品第一步需要选择的商品分类数据源
		 */
