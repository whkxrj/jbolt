...
public abstract class BaseShelfGoodsFloor<M extends BaseShelfGoodsFloor<M>> extends JBoltBaseModel<M>{
	 ...
	 * 商品分组ID
	 */
	@JBoltField(name="groupId" ,columnName="group_id",type="Integer", remark="商品分组ID")
	 ...
	 * 显示标题 默认是商品组的 可以改
	 */
	@JBoltField(name="title" ,columnName="title",type="String", remark="显示标题 默认是商品组的 可以改")
	 ...
	 * 显示商品数量
	 */
	@JBoltField(name="goodsCount" ,columnName="goods_count",type="Integer", remark="显示商品数量")
	 ...
	 * 显示几列布局
	 */
	@JBoltField(name="columnCount" ,columnName="column_count",type="Integer", remark="显示几列布局")
