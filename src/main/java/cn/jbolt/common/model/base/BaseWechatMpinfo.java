...
public abstract class BaseWechatMpinfo<M extends BaseWechatMpinfo<M>> extends JBoltBaseModel<M>{
	 ...
	 * 平台名称
	 */
	@JBoltField(name="name" ,columnName="name",type="String", remark="平台名称")
	 ...
	 * 头像LOGO
	 */
	@JBoltField(name="logo" ,columnName="logo",type="String", remark="头像LOGO")
	 ...
	 * 创建时间
	 */
	@JBoltField(name="updateTime" ,columnName="update_time",type="Date", remark="创建时间")
	 ...
	 * 简介
	 */
	@JBoltField(name="briefInfo" ,columnName="brief_info",type="String", remark="简介")
	 ...
	 * 类型 订阅号、服务号、小程序、企业号
	 */
	@JBoltField(name="type" ,columnName="type",type="Integer", remark="类型 订阅号、服务号、小程序、企业号")
	 ...
	 * 是否已认证
	 */
	@JBoltField(name="isAuthenticated" ,columnName="is_authenticated",type="Boolean", remark="是否已认证")
	 ...
	 * 申请认证主体的类型 个人还是企业
	 */
	@JBoltField(name="subjectType" ,columnName="subject_type",type="Integer", remark="申请认证主体的类型 个人还是企业")
	 ...
	 * 微信号
	 */
	@JBoltField(name="wechatId" ,columnName="wechat_id",type="String", remark="微信号")
	 ...
	 * 二维码
	 */
	@JBoltField(name="qrcode" ,columnName="qrcode",type="String", remark="二维码")
	 ...
	 * 关联应用ID
	 */
	public M setLinkAppId(java.lang.Integer linkAppId) {
		set("link_app_id", linkAppId);
		return (M)this;
	}
	 ...
	 * 关联应用ID
	 */
	@JBoltField(name="linkAppId" ,columnName="link_app_id",type="Integer", remark="关联应用ID")
	public java.lang.Integer getLinkAppId() {
		return getInt("link_app_id");
	}
