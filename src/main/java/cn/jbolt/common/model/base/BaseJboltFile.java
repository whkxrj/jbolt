...
public abstract class BaseJboltFile<M extends BaseJboltFile<M>> extends JBoltBaseModel<M>{
	 ...
	 * 保存物理地址
	 */
	@JBoltField(name="localPath" ,columnName="local_path",type="String", remark="保存物理地址")
	 ...
	 * 本地可访问URL地址
	 */
	@JBoltField(name="localUrl" ,columnName="local_url",type="String", remark="本地可访问URL地址")
	 ...
	 * 外部CDN地址
	 */
	@JBoltField(name="cdnUrl" ,columnName="cdn_url",type="String", remark="外部CDN地址")
	 ...
	 * 文件名
	 */
	@JBoltField(name="fileName" ,columnName="file_name",type="String", remark="文件名")
	 ...
	 * 文件类型 图片 附件 视频 音频
	 */
	@JBoltField(name="fileType" ,columnName="file_type",type="Integer", remark="文件类型 图片 附件 视频 音频")
	 ...
	 * 文件大小
	 */
	@JBoltField(name="fileSize" ,columnName="file_size",type="Long", remark="文件大小")
	 ...
	 * 后缀名
	 */
	@JBoltField(name="fileSuffix" ,columnName="file_suffix",type="String", remark="后缀名")
