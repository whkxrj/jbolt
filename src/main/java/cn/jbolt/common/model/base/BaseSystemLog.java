...
public abstract class BaseSystemLog<M extends BaseSystemLog<M>> extends JBoltBaseModel<M>{
	 ...
	 * 操作类型 删除 更新 新增
	 */
	@JBoltField(name="type" ,columnName="type",type="Integer", remark="操作类型 删除 更新 新增")
	 ...
	 * 连接对象详情地址
	 */
	@JBoltField(name="url" ,columnName="url",type="String", remark="连接对象详情地址")
	 ...
	 * 操作人ID
	 */
	@JBoltField(name="userId" ,columnName="user_id",type="Integer", remark="操作人ID")
	 ...
	 * 操作人姓名
	 */
	@JBoltField(name="userName" ,columnName="user_name",type="String", remark="操作人姓名")
	 ...
	 * 操作对象类型
	 */
	@JBoltField(name="targetType" ,columnName="target_type",type="Integer", remark="操作对象类型")
	 ...
	 * 操作对象ID
	 */
	@JBoltField(name="targetId" ,columnName="target_id",type="Integer", remark="操作对象ID")
	 ...
	 * 打开类型URL还是Dialog
	 */
	@JBoltField(name="openType" ,columnName="open_type",type="Integer", remark="打开类型URL还是Dialog")
