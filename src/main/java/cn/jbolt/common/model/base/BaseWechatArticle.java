...
public abstract class BaseWechatArticle<M extends BaseWechatArticle<M>> extends JBoltBaseModel<M>{
	 ...
	 * 更新用户 ID
	 */
	@JBoltField(name="updateUserId" ,columnName="update_user_id",type="Integer", remark="更新用户 ID")
	 ...
	 * 文章摘要
	 */
	@JBoltField(name="briefInfo" ,columnName="brief_info",type="String", remark="文章摘要")
	 ...
	 * 阅读数
	 */
	@JBoltField(name="viewCount" ,columnName="view_count",type="Integer", remark="阅读数")
	 ...
	 * 微信素材 ID
	 */
	@JBoltField(name="mediaId" ,columnName="media_id",type="String", remark="微信素材 ID")
	 ...
	 * 图文链接地址
	 */
	@JBoltField(name="url" ,columnName="url",type="String", remark="图文链接地址")
	 ...
	 * 本地图文 公众号图文素材 外部图文
	 */
	@JBoltField(name="type" ,columnName="type",type="Integer", remark="本地图文 公众号图文素材 外部图文")
