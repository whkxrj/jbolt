...
public class RealUrlDirective extends Directive {
	...
	public RealUrlDirective() {
		this("realUrl");
	}
	public RealUrlDirective(String directiveName) {
	...
	public void setExprList(ExprList exprList) {
		...
		if (paraNum ==0) {
			throw new ParseException("Wrong number parameter of #"+directiveName+" directive, one parameters allowed at most", location);
		}else if (paraNum == 1) {
