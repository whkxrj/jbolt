...
public class DemoController extends JBoltBaseController {
	@Inject
	...
	public void userAutocomplete() {
		renderJsonData(userService.getAutocompleteList(get("q"), getInt("limit",10),true,"name,username,pinyin,phone"));
	}
