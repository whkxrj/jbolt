...
public class JBoltVersionAdminController extends JBoltBaseController {
	@Inject
	...
	public void download() {
		renderBytesToExcelXlsFile(service.getExcelReport().setFileName("版本信息导出"));
	}
	...
	public void addFile() {
		...
		if(notOk(jboltVersionId)) {
			renderFormError("参数异常,请选择一个版本后再添加");
			return;
		}
		set("jboltVersionId", jboltVersionId);
		render("addfile.html");
