 ...
 * @date:   2019年11月9日   
 */
public class UpdateLibsService extends JBoltBaseService<UpdateLibs> {
	...
	public Ret toggleMust(Integer userId, Integer id) {
		...
		if(ret.isOk()){
			...
			return successWithData(updateLibs.getIsMust());
		}
		return  ret;
	}
	/**
	...
	public Ret toggleDeleteAll(Integer userId, Integer id) {
		...
		if(ret.isOk()){
			...
			return successWithData(updateLibs.getDeleteAll());
		}
		return ret;
	}
